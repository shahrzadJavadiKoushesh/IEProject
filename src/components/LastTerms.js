  ...
  return (
    <div className='terms-container'> 
      <div className='left'>
        ...
        <div className="home">خانه</div>
        <hr className="line"></hr>
        <div className="last-seen-term">آخرین ترم مشاهده شده</div>
        <div className="last-term">
            ترم بهار 1402
        </div>
        <div className="last-seen-courses">آخرین دروس مشاهده شده</div>
